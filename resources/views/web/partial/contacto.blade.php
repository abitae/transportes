<section class="py-12 overflow-hidden bg-gray-50" id="contacto">
    <div class="container px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-16 text-center">
            <h2 class="mb-4 text-3xl font-bold text-gray-900 md:text-4xl">Contáctanos</h2>
            <p class="max-w-2xl mx-auto text-lg text-gray-600">
                Estamos aquí para responder tus preguntas y ayudarte en lo que necesites. No dudes en ponerte en
        ...
        <div class="grid items-start grid-cols-1 gap-12 lg:grid-cols-2">
            ...
            <div class="overflow-hidden bg-white shadow-xl rounded-2xl">
                <div class="p-6 bg-blue-600">
                    ...
                    <p class="mt-2 text-blue-100">Completa el formulario y nos pondremos en contacto contigo lo antes
                        posible.</p>
                </div>
                ...
                <form action="{{ route('contacto.enviar') }}" method="POST" class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            <label for="nombre" class="block mb-1 text-sm font-medium text-gray-700">Nombre completo*</label>
                    ...
                    <div>
                        ...
                        <select name="select" id="asunto" required
                            ...
                            <option value="Cotización" {{ old('asunto') == 'Cotización' ? 'selected' : '' }}>Cotización
                            </option>
                            <option value="Soporte técnico" {{ old('asunto') == 'Soporte técnico' ? 'selected' : '' }}>
                        ...
                        <div class="ml-3 text-sm">
                            <label for="politicas" class="font-medium text-gray-700">
                                Acepto la <a href="{{ route('politicas-privacidad') }}"
                                    class="text-blue-600 hover:underline">política de privacidad</a> y el tratamiento de
            ...
            <div class="space-y-8">
                ...
                <!-- Mapa de ubicación -->
                <div class="p-4 overflow-hidden bg-white shadow-md rounded-xl">
