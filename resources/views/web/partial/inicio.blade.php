                    ...
                    <div class="overflow-hidden carousel-container">
                        <div class="carousel-track flex space-x-[10px] transition-transform duration-500" id="carouselTrack">
                            ...
                            <div class="flex-none carousel-item w-28 sm:w-32 md:w-36">
                                <div class="h-48 overflow-hidden transition-shadow duration-300 bg-white rounded-lg shadow sm:h-56 md:h-60 hover:shadow-lg">
...
<div class="flex flex-col gap-5 mb-2 md:flex-row">
    <div class="flex-1 relative overflow-hidden rounded-lg min-h-[300px] animate__animated animate__fadeInLeft hover:transform hover:scale-105 transition-transform duration-500">
    ...
    <div class="flex-1 relative overflow-hidden rounded-lg min-h-[300px] animate__animated animate__fadeInRight hover:transform hover:scale-105 transition-transform duration-500">
