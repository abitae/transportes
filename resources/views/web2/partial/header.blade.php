                ...
                <div class="main-menu__wrapper-inner">
                    <div class="main-header-two__inner">
                        <div class="logo-box-two">
                            <a href="/"><img src="web2/assets/images/resources/logo-white.png" width="220" alt=""></a>
                        </div>
                                    ...
                                    <div class="header-contact-style2">
                                        <ul>
                                            <li>
                                                ...
                                                <div class="text-box">
                                                    <p class="text1">atencion</p>
                                                    <p class="text2">Lunes - Domingo: 8am - 8pm</p>
                                                </div>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <div class="text-box">
                                                    <p class="text1">Correo</p>
                                                    <p class="text2"><a
                                                            href="mailto:yourmail@email.com">ventas@brayanbrush.pe</a>
                                                    </p>
                                                </div>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <div class="text-box">
                                                    <p class="text1">Telefono</p>
                                                    <p class="text2"><a href="tel:1234567890">998 985 982</a></p>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
