<div>
    <x-mary-card title="{{ $title }}" subtitle="{{ $sub_title }}" separator>
        <x-slot:menu>
            ...
            <x-mary-button @click="$wire.showHistory = true" icon="s-eye" label="History"
        ...
        <x-mary-form wire:submit="entryCaja">
            <div class="border border-green-500 rounded-lg">
                ...
                <x-slot:actions>
                    ...
                    <x-mary-button type="submit" spinner="save3" label="Save" class="bg-blue-500" spinner="entryCaja" />
                </x-slot:actions>
            </div>
        </x-mary-form>
    </x-mary-modal>
        ...
        <x-mary-form wire:submit="exitCaja">
            <div class="border border-red-500 rounded-lg">
                ...
                <x-slot:actions>
                    ...
                    <x-mary-button type="submit" spinner="save3" label="Save" class="bg-blue-500" spinner="exitCaja" />
                </x-slot:actions>
            </div>
        </x-mary-form>
    </x-mary-modal>
