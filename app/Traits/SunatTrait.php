...
trait SunatTrait
{
    ...
    {
        //metodo para calcular totales de la factura
        ...
        $data->mtoOperInafecto = $details->where('tipAfeIgv', 30)->sum('mtoValorVenta');
        ...
        $data->mtoImpVenta = floor($data->subTotal * 100) / 100;
